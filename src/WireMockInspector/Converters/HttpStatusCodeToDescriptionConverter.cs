...
public class HttpStatusCodeToDescriptionConverter : IValueConverter
{
    ...
    public static string TranslateStatusCode(object value)
    {
        if (value is string statusCodeString && int.TryParse(statusCodeString, out int statusCode))
        ...
        // Return a default description if the input is not a valid status code
